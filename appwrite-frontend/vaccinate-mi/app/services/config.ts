...
export const ENV = {
  ...
  APPWRITE_DATABASE_ID: process.env.EXPO_PUBLIC_APPWRITE_DATABASE_ID || '68beb588001a9f2d71dc',
 ...
 */
export const LIMITS = {
  // File upload limits (optimized for mobile)
  MAX_FILE_SIZE_MB: 5, // Reduced for mobile
  MAX_IMAGE_SIZE_MB: 3, // Reduced for mobile
  MAX_DOCUMENT_SIZE_MB: 10, // Reduced for mobile

  // Pagination limits
  DEFAULT_PAGE_SIZE: 20, // Smaller for mobile performance
  MAX_PAGE_SIZE: 50,

  // Bulk operations
  MAX_BULK_OPERATIONS: 25, // Reduced for mobile
...
export const UI_CONFIG = {
  ...
  ANIMATION_DURATION_MS: 250, // Faster for mobile
  LOADING_DELAY_MS: 300,

  // Layout (mobile-specific)
  HEADER_HEIGHT: 56, // Standard mobile header
  TAB_BAR_HEIGHT: 60, // Mobile tab bar
