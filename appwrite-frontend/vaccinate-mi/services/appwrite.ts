...
export const APPWRITE_CONFIG = {
  ...
  databaseId: process.env.EXPO_PUBLIC_APPWRITE_DATABASE_ID || '68beb588001a9f2d71dc',
...
export const COLLECTION_IDS = {
  // Core Collections
  FACILITIES: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_FACILITIES || 'facility',
  PATIENTS: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_PATIENTS || 'patients',
  VACCINES: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_VACCINES || 'vaccines',
  IMMUNIZATION_RECORDS: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_IMMUNIZATION_RECORDS || 'immunization-records',

  // Notification System
  NOTIFICATIONS: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_NOTIFICATIONS || 'notifications',

  // Supplementary Immunizations
  SUPPLEMENTARY_IMMUNIZATIONS: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_SUPPLEMENTARY_IMMUNIZATIONS || 'supplementary-immunizations',

  // Scheduling Collections
  VACCINE_SCHEDULES: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_VACCINE_SCHEDULES || 'vaccine-schedules',
  VACCINE_SCHEDULE_ITEMS: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_VACCINE_SCHEDULE_ITEMS || 'vaccine-schedule-items',

  // Profile Collections
  ADMIN_PROFILES: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_ADMIN_PROFILES || 'admin-profiles',
  EMPLOYEE_PROFILES: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_EMPLOYEE_PROFILES || 'employee_profiles',
  PATIENT_PROFILES: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_PATIENT_PROFILES || 'patient-profiles',
  PROFILE_VERIFICATION_WORKFLOW: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_PROFILE_VERIFICATION_WORKFLOW || 'profile-verification-workflow',

  // Audit & Compliance Collections
  ACCESS_AUDIT_LOG: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_ACCESS_AUDIT_LOG || 'access-audit-log',
  ROLE_CHANGE_LOG: process.env.EXPO_PUBLIC_APPWRITE_COLLECTION_ROLE_CHANGE_LOG || 'role-change-log',
} as const;
...
export function validateEnvironment(): { isValid: boolean; errors: string[] } {
  ...
  if (!process.env.EXPO_PUBLIC_APPWRITE_DATABASE_ID) {
    errors.push('EXPO_PUBLIC_APPWRITE_DATABASE_ID is not defined');
  }
